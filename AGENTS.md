...
- `/Users/zha/Documents/CodeSpaces/evo-craft`

Any result produced with `@superpowers`, Superpowers skills, or any other Codex skill/tool workflow must be stored under `/Users/zha/Documents/CodeSpaces/evo-craft` when it is relevant to this project.

任何通过 `@superpowers`、Superpowers 技能，或其他 Codex 技能/工具流程产生的项目相关结果，都必须放到 `/Users/zha/Documents/CodeSpaces/evo-craft` 这个项目目录下面。
...
- Do not finish, commit, or push skill-driven work until the project-relevant skill outputs have been saved under `/Users/zha/Documents/CodeSpaces/evo-craft` and included in the intended commit.
