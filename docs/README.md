...
- [PRD 编写规范](prd/2026-05-16-prd-writing-standards.md)：参考主流 PRD 与需求工程资料提炼的 EvoCraft PRD 结构、质量规则、检查清单和模板。
- [MVP PRD v1.2](prd/2026-05-10-wrong-question-capture-mvp-prd.md)：用于生成 UI 图和指导开发的错题收集 MVP 产品需求文档。
...
6. 进度记录必须包含：本轮任务、已完成、卡点、执行命令、下一步计划。
7. 原始想法放在 `docs/ideas/`，已经收敛的产品需求放在 `docs/prd/`。
