...
当前目标：把 PRD v1.0 和 B 方案设计基线落成第一个可用的本地 Web MVP，并用真实浏览器验证上传、识别复核、保存和详情查看闭环。
...
4. 在 `docs/planning/evocraft-roadmap-progress.md` 添加具体进度记录，包含本轮任务、已完成、卡点、执行命令、下一步计划。
5. PRD 保持聚焦：一个 PRD 尽量只覆盖一个主要能力。
