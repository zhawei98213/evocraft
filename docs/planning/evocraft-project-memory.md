...
- Logo 首轮方向已保存到 `docs/design/logo/2026-05-18-evocraft-logo-options.md`。当前推荐 EvoCraft 总品牌优先采用“成长方块 + 叶片 + 电路线”方向；用户已要求沿左上 A 方向继续优化 `错题收集` 子应用图标，精修稿保存为 `docs/design/logo/2026-05-18-evocraft-logo-scan-notebook-v2.png`。最终矢量化前仍需小尺寸可读性验证。
